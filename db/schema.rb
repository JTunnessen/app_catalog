...
ActiveRecord::Schema.define(version: 20160430193547) do
  ...
  create_table "apps", force: :cascade do |t|
    ...
    t.string   "prog_lang_eol_1"
    t.string   "framework_1"
    t.string   "framework_eol_1"
    t.string   "tech_stack_1"
    t.string   "tech_stack_eol_1"
    t.string   "tech_stack_2"
    t.string   "tech_stack_eol_2"
    t.string   "tech_stack_3"
    t.string   "tech_stack_eol_3"
    t.string   "tech_stack_4"
    t.string   "tech_stack_eol_4"
    t.string   "tech_stack_5"
    t.string   "tech_stack_eol_5"
    t.string   "tech_stack_6"
    t.string   "tech_stack_eol_6"
    t.string   "sys_dep_1"
    t.string   "sys_dep_2"
    t.string   "sys_dep_3"
    t.string   "sys_dep_4"
